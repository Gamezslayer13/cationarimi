...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Binaltın Yapı — Ankara Çatı ve Demir İşleri" },
      { name: "description", content: "Ankara'nın güvenilir çatı ve demir işleri uzmanı. 15+ yıl deneyim, ücretsiz keşif." },
      { name: "author", content: "Binaltın Yapı" },
